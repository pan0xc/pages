...
> {lang="en"}
{cite="https://nixos.org" caption="nixos.org"}
...
在 Fedora 上安装 Nix 上安装很容易，我这里不使用 Nix 官网提供的脚本进行安装，而是直接使用 Fedora 的包管理器进行安装，执行以下命令即可
安装然后立即启动：
...
写这篇博客不久我就从 **Fedora** 换到了 **NixOS**，NixOS 实在太舒服了，所以呢，这篇博客就到此结尾了。
哈哈😄！
